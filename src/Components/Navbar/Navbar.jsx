...
class Navbar extends Component {
	...
	matchParentWidth() {
		let parentWidth = $('.nav-wrapper').parent().width();
	...
	render() {
		const { height, size, orientation, links } = this.props;
		...
		if (size === 'large') {
			...
			return (
				<div className="nav-wrapper">
					...
					<div id="menuIcon">
						<MenuIcon sidebarIsOpen={sidebarIsOpen} menuIconClick={this.checkSidebarState} />
					</div>
