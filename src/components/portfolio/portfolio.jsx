...
const CARDS = [
	...
	},
	{
		...
		title: 'Weather App (JS+Bootstrap)',
		image: screenWeather,
		website: '',
		firebase: 'https://weather.ptrchoi.com',
		codepen: '', // codepen: 'https://codepen.io/ptrchoi/pen/grwMJv',
		description: `Pure Javascript Weather app which leverages device HTML5 geolocation data for generation of real-time local weather conditions.
		
		Features:
		- OpenWeatherMap API and device geolocation integration
		- Vanilla JS | Bootstrap | CSS3 | HTML5 | Firebase`
	},
	{
